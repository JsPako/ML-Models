...
class LogisticRegression:
    ...
    #   data point, the probability of that data point belonging to a class is predicted using the standard logistic
    #   function. The target value is calculated by taking the probability of it being a high or low value and using
    #   a log function with an upper and lower boundary value.
    ...
    def fit(self, training_data, training_values, epoch=5000, alpha=0.01):
        ...
        #   This is the key function in the logistic regression algorithm, it takes the training data points and using
    ...
    def predict(self, testing_data):
        ...
        #   This function takes unseen data points and calculates the target value (y) using the standard logistic
        #   function and a log function with dynamically assigned upper and lower boundaries. This calculation is done
        #   per available feature and the values from those calculations are averaged and then returned as the
        #   predicted value.
    ...
    def _standard_logistic_function(value, coefficient, intercept):
        ...
        #   Standard Logistic Function (also known as Sigmoid Function)

        #   Calculates the output of the standard logistic function for given input value, coefficient, and intercept.
        #   The output from this function is used in the probability and prediction calculations during the predict
        #   phase.
    ...
    def mean_squared_error(self, testing_values):
        ...
        #   This function is needed to evaluate the performance of the logistic regression, provided the testing values
        #   this function calculates the MSE of the predicted values against the true testing values. Based on the MSE
        #   value this function returns, you can evaluate how well the model is performing, and if the model needs
        #   adjusting which is done by changing the epoch iteration number or by changing the alpha learning rate.
